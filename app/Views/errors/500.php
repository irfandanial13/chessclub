...
<body class="elite-chess-theme">
    ...
    <div class="auth-container elite-login">
        <div class="elite-header">
            <div class="club-logo">
                ...
                <div class="brand-section">
                    ...
                    <div class="club-subtitle">Server Error</div>
                </div>
            </div>
        ...
        <div class="error-content" style="text-align: center; padding: 2rem 0;">
            <div class="error-icon" style="font-size: 8rem; color: #ffc107; margin-bottom: 1rem;">
        ...
        <div class="error-actions" style="margin-top: 2rem;">
            <a href="javascript:location.reload()" class="elite-button" style="margin-right: 1rem;">
            ...
            <a href="<?= base_url('/') ?>" class="elite-button" style="background: #666;">
                <span class="button-text">
