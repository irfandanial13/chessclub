...
<body class="elite-chess-theme">
    ...
    <div class="auth-container elite-login">
        <div class="elite-header">
            <div class="club-logo">
                ...
                <div class="brand-section">
                    ...
                    <div class="club-subtitle">Access Forbidden</div>
                </div>
            </div>
        ...
        <div class="error-content" style="text-align: center; padding: 2rem 0;">
            <div class="error-icon" style="font-size: 8rem; color: #dc3545; margin-bottom: 1rem;">
        ...
        <div class="error-actions" style="margin-top: 2rem;">
            ...
            <a href="<?= base_url('login') ?>" class="elite-button" style="background: #28a745;">
                <span class="button-text">
