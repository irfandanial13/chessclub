...
<html>
<head>
    <title>Cash on Delivery - Chess Club Merchandise</title>
        ...
        <div class="payment-form">
            ...
            <div class="info-box">
                ...
                <ul style="margin: 0; padding-left: 20px;">
                    <li>Enter your delivery details below</li>
                    <li>We'll process your order immediately</li>
                    <li>Pay with cash when the delivery arrives</li>
                    <li>No additional fees for cash payment</li>
                </ul>
            </div>
            ...
            <form method="post" action="<?= base_url('merchandise/complete-order') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="notes" name="notes" placeholder="Any special instructions for delivery">
                </div>
